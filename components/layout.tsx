  ...
  return (
    <>
        <Head>
            ...
            <meta name="Savelink" content="Web app to safely store and categorise links from all across the web" />
            <meta name='application-name' content='Savelink' />
            <meta name='apple-mobile-web-app-capable' content='yes' />
            <meta name='apple-mobile-web-app-status-bar-style' content='default' />
            <meta name='apple-mobile-web-app-title' content="Web app to safely store and categorise links from all across the web" />
            <meta name='description' content='Web app to safely store and categorise links from all across the web'/>
            ...
            <meta name='twitter:description' content='Web app to safely store and categorise links from all across the web' />
            <meta name='twitter:image' content='/icon-192x192.png' />
            <meta name='twitter:creator' content='@adedotxn' />
            <meta property='og:type' content='website' />
            <meta property='og:title' content='' />
            <meta property='og:description' content='Web app to safely store and categorise links from all across the web' />
